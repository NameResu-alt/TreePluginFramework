 ...
 */
public class TPFDAGEdgeDeletionMetaEvent extends TPFDAGMetaEvent {
    private final DAGNodeMetadata from;
    private final DAGNodeMetadata to;

    public TPFDAGEdgeDeletionMetaEvent(UUID tpf_uuid, String eventDescription, UUID dagUUID, int version, DAGNodeMetadata from, DAGNodeMetadata to) {
